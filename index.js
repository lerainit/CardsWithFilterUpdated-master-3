...
new CardforCardiologist(23,'Еременко Юрий','кардиолог','обследование','коронарография','неотложная','156','29','60','инфаркт').render('.container')

//(id,name,doctor,purpose,description,urgency)
//pressure,weight,age,disease